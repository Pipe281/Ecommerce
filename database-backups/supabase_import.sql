-- Supabase/PostgreSQL import generado desde ecommerce_mysql_backup_2026-09-04.sql
-- Las contrasenas de usuarios fueron omitidas intencionalmente; usa Supabase Auth.
BEGIN;
...
CREATE TABLE legacy_users (id integer PRIMARY KEY, username varchar(100) NOT NULL, email varchar(255) NOT NULL UNIQUE, created_at timestamptz DEFAULT CURRENT_TIMESTAMP);
INSERT INTO legacy_users (id, username, email, created_at) VALUES (1, 'Felipe', 'felipe@test.cl', '2026-06-11 21:21:48'), (2, 'Juan', 'juan@test.cl', '2026-06-11 21:49:22'), (3, 'Ana', 'anan@test.cl', '2026-06-17 16:37:04');
...
CREATE TABLE carts (
  ...
  PRIMARY KEY (id),
  CONSTRAINT fk_carts_user FOREIGN KEY (user_id) REFERENCES legacy_users (id) ON DELETE CASCADE
);
